 ...
 <script type="text/javascript">
    ...
    $(document).ready(function(){
       ...
       function uf_enviar_digitalizar(idProceso, idArchivo) {
        ...
        function checar_estado_trabajo(elemento, id, idArchivo, preregistro, recibir, revisar, foliar, validar, digitalizar, editar, usuario){
            if (elemento.checked){
        ...
        function agregar_ubicacion_fisica(){
            ...
            $("#modal-agregar-ubicacion-fisica").modal('hide');
                $.ajax({
                    ...
                    url: "<?php echo site_url('archivo/agregar_ubicacion_fisica/'); ?>",
                     success: function (data, textStatus, jqXHR) {
                         $("#Ubicaciones_agregadas"+ proceso).html(ubicacion);
                         $("#Ubicaciones_agregadas"+ proceso).show();
                     }
                }) ;
        }
            ...
            <div class="row clearfix container-fluid">
                ...
                ?>           
                    ...
                    <div class="col-xs-12 col-sm-3" <?php //echo $style_preregistro  ?>>
                        ...
                        <div class="panel-group" id="panel-proceso-">
                                                ...
                                                <td  colspan="2">
                                                    <div>
                                                        ...
                                                        <label class=""> Trabajar con Bloque:
                                                            <input id="estado-trabajo" type="checkbox" class="" onchange="checar_estado_trabajo(this)">
                                                ...
                                                <td colspan="2">
                                                 <?php //if ($recibe ==1){?>   
                                                    <div>
                                                        ...
                                                        <table  id="info-oculto-"  width="100%">
                                                        
                                                            <tr>

                                                                <td align="end">
                                                                    <div class="btn-ubicaciones">
                                                                        <a href="#" id="btn-agregar-ubi"  class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-agregar-ubicacion-fisica" role="button" onclick="uf_agregar_ubicacion()"><span class="glyphicon glyphicon-plus-sign"></span> Agregar Ubicación </a>
                                                                    </div>
                                                                </td>
                                                    ...
                                                    <div id="Ubicaciones_agregadas<?php echo $rRow->id ?>" class="d-n"></div>
                                                     <?php
                                                                          ...
                                                                          <div class="row">
                                                                              ...
                                                                              <div class="col-sm-2  m-b-separacion" >
                                                                                  <div class="row">
                                                                                      ...
                                                                                      <?php } else { 
                                                                                           echo '<b>No Hojas: </b>' . $rRowDocumentos->noHojas; 
                                                                                                  ...
                                                                                                  <div class="col-sm-12">
                                                                                                      <section id="<?php echo "section_".$rRowDocumentos->id; ?>" class="row">
                                                                                                          ...
                                                                                                          <?php if ($preregistro==1 || $recibe == 1 || $reviso ==1){ ?> 
                                                                                                                  ...
                                                                                                                  <div class="btn-observaciones col-xs-12 col-sm-4">
                                                                                                                      <a href="#" id="btn-agregar-obs"  data-toggle="modal" data-target="#observacion_bloque" role="button" class="btn btn-success" onclick="uf_agregar_observaciones(<?php echo $rRow->id .' , ' . $rRowSubProcesos->id . ' , ' .$rRowDocumentos->idDoc; ?>)">
                                                                                                                          <span class="glyphicon glyphicon-plus-sign"></span> Agregar Observaciones
                                                                                                                      </a>
                                                                                                                  </div>
                                                                                                              
                                                                                                                  <div class="btn-observaciones col-xs-12 col-sm-3">
                                                                                                                        ...
                                                                                                                        <div class="row clearfix"> 
                                                                                                                            ...
                                                                                                                            <div class="col-md-12 column">
                                                                                                                                    ...
                                                                                                                                    <table class="table table-striped table-bordered table-hover text-center">
                                                                                                                                      ...
                                                                                                                                      <?php }  // foreach $qDocumentosAnexos
                                                                                                                                           ?>
                                                                                                                                    </table>
                                                                                                                                    <?php  
                                                                                                                                          } //iset Documentos Anexos
                                                                                                                                      } //  Documentos Anexos rows
                                                                                                                                    ?>   
                    ...
                    </div> <!-- columna procesos -->
                        
                     
                </div> <!-- row-->
                     
                <?php
                     }  //$qUbicacion->num_rows()>0
                ?>
                    ...
                    <div class="modal-content">
                        ...
                        <form  class="form-horizontal">
                            ...
                            <div class="modal-footer">
                                ...
                                <a class="btn btn-primary" onclick="agregar_ubicacion_fisica()">Guardar</a>                   
                                <button type="button" class="btn btn-danger" data-dismiss="modal">
                                    Cancelar
                                </button>                     
                            </div>
