                           ...
                           success: function(data) {
                             //$('.center').html(data); 
                                ...
                                if (preregistro==1){
                                    ...
                                    $('#numero_documentos_subproceso_preregistrados_preregistro'+data["idSubTipoProceso"]).html(data["strSubTipoProceso_preregistrados"])
                                } else{
        ...
        function uf_recibido_cid(elemento,id, idRel_Archivo_Documento) {
                        ...
                        $.ajax({
                           ...
                           success: function(datos) {
                               ...
                               $('#numero_documentos_proceso_recibidos'+datos["idTipoProceso"]).html(data["strTipoProceso_recibido"])
                               $('#numero_documentos_subproceso_recibidos'+datos["idSubTipoProceso"]).html(data["strSubTipoProceso_recibido"])
                            ...
                            <?php foreach ($qPreregistros->result() as $rPreregistros): ?>
                              ...
                              <?php else: ?>
                                ...
                                <?php if ($recibe == 1):?>
                                  <!-- Recibe ==1 -->
                                  <?php $visualizo = 1 ?>
                                  <?php ($Estatus == 10) ? $disabled_recibe = "" : $disabled_recibe = "disabled='disabled'" ;?>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">  
                                                <?php if ($rPreregistros->tipo_documento == 4): ?>
                                                  ...
                                                  <!--  Estimacion -->   
                                                  <select <?= $disabled_recibe ?> class="form-control" name="tipo_documento<?php echo $rRowDocumentos->id; ?>" id="tipo_documento<?php echo $rRowDocumentos->id; ?>" onchange="uf_recibir_tipo_documento(<?= $rRowDocumentos->id; ?>,<?= $idArchivo ?> ,<?= $preregistro ?>)" >
                                ...
                                <?php if ($reviso == 1 && $rPreregistros->recibido_cid == 1):?>
