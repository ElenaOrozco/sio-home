        ...
        <div id="row-documento" class="row">
            ...
            <div id="row-title" class="col-md-6 col-xs-12">
                ...
                <div class="direccion m-b">
                    <select class="form-control" name="idDireccion<?php echo $rRow->idRAD; ?>" id="idDireccion<?php echo $rRow->idRAD; ?>" >
            ...
            <div id="row-hojas" class="col-md-2">
                ...
                <input type="number" class="form-control" id="noHojas_doc_<?= $rRow->idRAD ?>" min="0" name="noHojas_doc" placeholder="No Hojas" value=""
                         onchange="cargar_noHojas(event,<?= $rRow->idRAD ?>, <?= $idArchivo ?>)" onkeyup="cargar_noHojas_cid(event,<?= $rRow->idRAD ?>, <?= $idArchivo ?>)" onkeypress="return validar(event)">
