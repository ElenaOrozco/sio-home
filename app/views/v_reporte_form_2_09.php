 ...
 <script type="text/javascript">
    ...
    <body  class="m-b-body" style="overflow: visible;">
                ...
                <div class="col-xs-12 col-sm-3" <?php echo $style_preregistro  ?>>
                   ...
                   if (isset($qUsuario_trabajando)) {
				    ...
				    <?php                                   
                                    ...
                                    <li class="active list-style" id="enviar_revision_<?php echo $rRow->id; ?>">
                                        <a href="#" data-toggle="modal" data-target="#enviar_revision" role="button"  onclick="uf_enviar_revision(<?php echo $rRow->id; ?>, <?php echo $idArchivo; ?>)"><span class="glyphicon glyphicon-share-alt"></span> Enviar Revisión</a>
                                    </li>
                                                 ...
                                                 <?php
                                                        ...
                                                        $qDocumentos_sub_proceso_recibido = $this->ferfunc->get_reg_libre("SELECT DISTINCT  `saaRel_Archivo_Preregistro`.`id_Rel_Archivo_Documento`
                                                                ...
                                                                ON `saaRel_Archivo_Preregistro`.id_Rel_Archivo_Documento = saaRel_Archivo_Documento.id
                                                                 WHERE saaRel_Archivo_Documento.idArchivo=" .$idArchivo . " AND  saaRel_Archivo_Documento.idTipoProceso= ". $rRow->id ."
        ...
        */
                                                ...
                                                $qDocumentos =  $qDocumentos = $this->ferfunc->get_reg_libre(
                                                          "SELECT DISTINCT `saaRel_Archivo_Documento`.`id`, `saaRel_Archivo_Documento`.`idUsuario_recibio`, `saaRel_Archivo_Documento`.`idDireccion_responsable` AS direccion_preregistro, 
                                                              saaDocumentos.idDireccion_responsable,
                                                        `saaDocumentos`.`id` AS idDoc, `saaDocumentos`.`Nombre` , `saaRel_Archivo_Preregistro`. id AS idPreregistro,
                                                        `saaRel_Archivo_Documento`.`revisado`,
                                                        `saaRel_Archivo_Preregistro`.`idArchivo`,
                                                         saaRel_Archivo_Documento.idDireccion_responsable AS direccion_preregistro,
                                                        `saaRel_Archivo_Preregistro`.`idDireccion_responsable`,
                                                        `saaRel_Archivo_Preregistro`.`tipo_documento`,
                                                        `saaRel_Archivo_Preregistro`.`noHojas`,
                                                        `saaRel_Archivo_Preregistro`.`preregistro_aceptado`,
                                                        `saaRel_Archivo_Preregistro`.`idUsuario_acepta`,
                                                        `saaRel_Archivo_Preregistro`.`recibido_cid`,
                                                        `saaRel_Archivo_Preregistro`.`idUsuario_recibe`

                                                        FROM `saaRel_Archivo_Documento`
                                                        LEFT JOIN `saaRel_Archivo_Preregistro` 
                                                        ON
                                                        `saaRel_Archivo_Preregistro`.id = `saaRel_Archivo_Documento`.`id_preregistro` 
                                                        INNER JOIN saaDocumentos ON 
                                                        saaRel_Archivo_Documento.idDocumento = saaDocumentos.id
                                                        WHERE `saaRel_Archivo_Documento`.`eliminacion_logica` = 0
                                                        AND `saaRel_Archivo_Documento`.idArchivo = " . $idArchivo . " AND saaDocumentos.idSubTipoProceso=" .$rRowSubProcesos->id);
                ...
                foreach ($qDocumentos->result() as $rRowDocumentos) {
                  ...
                  <div class="panel-group" id="panel-documentos-<?php echo $rRowDocumentos->id;  ?>">
                    ...
                    <div class="row"> <!--row idRel_archivo -->
                        ...
                        <?php 
                        $no_contiene_preregistros = 0;
                        $contiene_preregistro_aceptado=0;
                        if(($preregistro ==1 || $recibe ==1 || $reviso == 1) && $Estatus <= 30){
                            $qPreregistros = $this->ferfunc->get_reg_libre("SELECT * FROM `saaRel_Archivo_Preregistro`
                             ...
                             $disabled = '';
                              ...
                              if($Estatus >= 30) {//si ya esta revisado
                        ...
                        ?>
                              ...
                              <div class="col-sm-12 m-b-separacion">
                                  ...
                                  <!--  HY PREREGRISTO REVISO O RECIBE y No hay preregistros
                                  rRow-> Procesos  rRowSubProcesos->subprocesos  rRowDocumentos->idRel_Archivo_Documento -->
                                  ...
                                  <div class="col-sm-8">
                                      ...
                                      <div class="">  <!--Row tipodocumento -->
                                          ...
                                          ?>
                                                ...
                                                <select class="form-control" name="tipo_documento<?php echo $rRowDocumentos->id; ?>" id="tipo_documento<?php echo $rRowDocumentos->id; ?>" onchange="uf_recibir_tipo_documento(<?= $rRowDocumentos->id; ?>,<?= $idArchivo ?>)" <?= $disabled ?>>
                                  ...
                                  <div class="col-sm-4">
                                    <div class="">
                                      ...
                                      if($recibe ==1  && $Estatus==10){
                                        ...
                                        ?>
                                      <input   type="checkbox" value="" onchange="uf_recibido_cid(this, <?= $rPreregistros->id ?>, <?= $rPreregistros->id_Rel_Archivo_Documento ?>)" <?= $checked ?>> Recibido
                                      <?php } else { ?>
                                      <input   type="checkbox" value="" disabled="disabled" <?= $checked ?>> Recibido
                                      <?php } ?>
                                    </div>
                                    <div class="" >
                                      ...
                                      ?>
                                      <input  type="checkbox"  value="" onchange="uf_recibir_revisado(this,  <?= $rPreregistros->id ?> ,<?= $rRowDocumentos->id ?>)"> Revisado
                                      <?php } else { ?>
                            ...
                            <?php  } else {  // Fin  num_rows == 0 ?>
                            <?php 
                            
                             // si  hay preregistrados  y Preregistro recibe o reviso*/
                            
                              $contiene_preregistros_de_direccion = 0;
                              $contiene_recibidos_cid =0;
                              $contiene_preregistro_aceptado=0;
                            ...
                            <?php  foreach ($qPreregistros->result() as  $rPreregistros) {
                                         ...
                                         if ($rPreregistros->recibido_cid == 1){
                                              $doc_recibido= "checked";
                                         }

                                            //$rPreregistros->tipo_documento ;
                                          if ($rPreregistros->tipo_documento == 4){ 
                                          ...
                                          } else { // si no es estimacion

                                            if($rPreregistros->tipo_documento==0){
                                            ...
                                            if($rPreregistros->tipo_documento==2){
                                            ...
                                            if($rPreregistros->tipo_documento==3){
                        ...
                        ?>
                            <?php if ($preregistro == 1 ){
                                    ...
                                    if($idDireccion_responsable == $rPreregistros->idDireccion_responsable) { 
                                        
                                        $contiene_preregistros_de_direccion = 1;
                            ?>

                                 <!--  Preregistro :hay preregistros  y son igual a direccion  <?= $rPreregistros->idDireccion_responsable ?> == <?= $idDireccion_responsable ?>
                              ...
                              <div class="col-sm-12 m-b-separacion">
                                  ...
                                  <!--  hay PreregiStros  y son igual a direccion - <?= $rPreregistros->idDireccion_responsable ?> == <?= $idDireccion_responsable ?>
                                  ...
                                  <div class="col-sm-8">
                                      ...
                                      <div class="">  <!--Row tipodocumento -->
                                              ...
                                              <?php if ($rPreregistros->tipo_documento == 4){ ?> 
                                                <select class="form-control" name="tipo_documento<?php echo $rRowDocumentos->id; ?>" id="tipo_documento<?php echo $rRowDocumentos->id; ?>" onchange="uf_recibir_tipo_documento_preregistro(<?= $rRowDocumentos->id; ?>,<?= $idArchivo ?>)" <?= $disabled ?>>
                                      ...
                                      <div class="m-t">  <!--Row Hojas -->
                                               ...
                                               <label class="sr-only" for="exampleInputEmail3">No. Hojas</label>
                                               <input type="number" class="form-control" id="noHojas_doc_<?= $rRowDocumentos->id ?>" min="0" name="noHojas_doc" placeholder="No Hojas" value="<?= $rPreregistros->noHojas ?>" onchange="cargar_noHojas(event,<?= $rRowDocumentos->id ?>, <?= $idArchivo ?>)" onkeyup="cargar_noHojas(event,<?= $rRowDocumentos->id ?>, <?= $idArchivo ?>)" onkeypress="return validar(event)"  >
                              ...
                              </div> <!--col-sm-3 mb-separacion-->

                              <?php } else { //sino, es Preregistro pero no hay de la direccion ?>  

                                <?php if($contiene_preregistros_de_direccion == 0) { 
                                    $contiene_preregistros_de_direccion == 1
                                            ?>

                                    <div class="col-sm-12 m-b-separacion">
                                
                                  <!--  HY PREREGRISTO: No hay preregistros de la direccion $contiene_p_d <?=$contiene_preregistros_de_direccion ?>
                                  rRow-> Procesos  rRowSubProcesos->subprocesos  rRowDocumentos->idRel_Archivo_Documento -->
                              ...
                              <?php }  // else si la direccion no  es ==?>    
                            ...
                            <?php
                              ...
                              } //fin si preregistro == 1
                            ?>

                            <?php if(($reviso == 1 || $recibe ==1  ) && $rPreregistros->preregistro_aceptado==1){ 
                                $disabled_reviso="";
                                if ($recibe ==1 && $Estatus ==20){
                                    $disabled_reviso="disabled='disabled'";
                                }
                            
                                    if($rPreregistros->preregistro_aceptado==1){
                                        $contiene_preregistro_aceptado =1;
                            ?>

                              <div class="col-sm-12 m-b-separacion">
                                
                                  <!--  HY REVISO O RECIBE y preregistro aceptado $contiene_preregistro_aceptados=  <?= $contiene_preregistro_aceptado ?>
                                  $preregistro   <?= $preregistro ?> $recibe <?= $recibe ?> -->
                                ...
                                <div class="row"> 
                                  ...
                                  <div class="col-sm-8">
                                      ...
                                      <div class="">  <!--Row tipodocumento -->
                                          ...
                                          ?>
                                                ...
                                                <select class="form-control" name="tipo_documento<?php echo $rRowDocumentos->id; ?>" id="tipo_documento<?php echo $rRowDocumentos->id; ?>" onchange="uf_recibir_tipo_documento(<?= $rRowDocumentos->id; ?>,<?= $idArchivo ?>)" <?= $disabled ?> <?= $disabled_reviso ?>>
                                  ...
                                  <div class="col-sm-4">
                                    ...
                                    <div class="" >
                                      ...
                                      ?>
                                      <input  type="checkbox" <?=  $doc_revisado ?> value="" onchange="uf_recibir_revisado(this, <?= $rPreregistros->id ?> , <?= $rRowDocumentos->id ?>)"> Revisado
                                      <?php } else { ?>
                                      <input  type="checkbox"  <?=  $doc_revisado ?> value="" disabled="disabled"> Revisado
                                ...
                                <?php 
                                      } //de si es recibe o reviso y no hay preregistro aceptado */?>
                            <?php 
                               
                                
                                } // fin revisar o recibir  
                            ?>
  


                        <?php } //Fin foreach preregistros ------
                            } // Fin preregistro num rows == 0
                            
                        } else { // fin si recibe preregistro reviso
                        ...
                        <div class="col-sm-12 m-b-separacion">
                                  ...
                                  <!-- si no es preregistro recibe o reviso o estatus <=30
                                  rRow-> Procesos  rRowSubProcesos->subprocesos  rRowDocumentos->idRel_Archivo_Documento -->
                                ...
                                <div class="row"> 
                                  ...
                                  <div class="col-sm-8">
                                      ...
                                      <div class="">  <!--Row tipodocumento -->
                                          <?php if ($rRowDocumentos->tipo_documento == 4){ 
                                            $seleccion = "Contiene Estimaciones";
                                            $value='value="4"';
                                            $seleccion1 = "Selecciona una opción";
                                            $value1 = 'value="0"';
                                          ...
                                          <?php  } else { // si no es estimacion
                                            ...
                                            if($rRowDocumentos->tipo_documento== 0 ){
                                            ...
                                            if($rRowDocumentos->tipo_documento==1){
                                            ...
                                            if($rRowDocumentos->tipo_documento ==2){
                                            ...
                                            if($rRowDocumentos->tipo_documento==3){
                                      ...
                                      <div class="m-t">  <!--Row Hojas -->
                                                <!-- Validar $rRowDocumentos->id  ==  id Rel_Archivo_Documento -->
                                                
                                               <label class="sr-only" for="exampleInputEmail3">No. Hojas</label>
                                               <input type="number" class="form-control" id="noHojas_doc_<?= $rRowDocumentos->id ?>" min="0" name="noHojas_doc" placeholder="No Hojas" value="<?= $rRowDocumentos->noHojas ?>" onchange="cargar_noHojas(event,<?= $rRowDocumentos->id ?>, <?= $idArchivo ?>)" onkeyup="cargar_noHojas(event,<?= $rRowDocumentos->id ?>, <?= $idArchivo ?>)" onkeypress="return validar(event)" disabled="disabled" >
                      ...
                      <?php } //else es recibe o reviso o preregistro  ?>
                              
                    <?php
                                    
                                        if (($contiene_preregistro_aceptado== 0 && $no_contiene_preregistros == 0)&& ($recibe==1 || $reviso==1)){
                                           
                                
                                ?>
                                   <div class="col-sm-12 m-b-separacion">
                                
                                  <!-- DESPUES del for $contiene_preregistro_aceptado== 0 && $no_contiene_preregistros == 0)&& ($recibe==1 || $reviso==1) HY REVISO O RECIBE y preregistro no aceptado 'Contiene aceptados ' <?= $contiene_preregistro_aceptado; ?>
                                  rRow-> Procesos  rRowSubProcesos->subprocesos  rRowDocumentos->idRel_Archivo_Documento -->
                    ...
                    <div class="col-sm-7" >
                      <div class="panel panel-warning">
                        ...
                        <div class="col-sm-2" >
                            <!---Direccion responsable <?= $rRowDocumentos->idDireccion_responsable ?> -->
                            <div>
