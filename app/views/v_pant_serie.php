...
<html lang="es">
    <head>
        ...
        function uf_modificar_serie(id) {

                $("#idCatalogo").val(id);
               
                $.ajax({
                    url: "<?php echo site_url('serie/datos_serie') ?>/" + id,
                    dataType: 'json',
                                    ...
                                    if (isset($qListado)) {
                                        if ($qListado->num_rows() > 0) {
                                            foreach ($qListado->result() as $rSolicitud) {
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="#" class="btn btn-success btn-xs" title=""  data-toggle="modal" data-target="#modal-modificar-cat" role="button" onclick="uf_modificar_serie(<?php echo $rSolicitud->id; ?>)"><span class="glyphicon glyphicon-pencil"></span></a>&nbsp;
                                                        <a class="btn btn-danger btn-xs del_documento" title="Eliminar Solicitud" onclick="return confirm('¿Confirma eliminar Registro?');" target="_self" href="<?php echo site_url('serie/eliminar_cat/' . $rSolicitud->id); ?>" ><span class="glyphicon glyphicon-remove" ></span></a>
                                                    </td>
                                                    <td>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-titlsamplee" id="modal-nuevo_documentomyModalLabel">Serie - Nuevo</h4>
                    </div>
                    <form action="<?php echo site_url("serie/agregar_cat"); ?>" method="post" name="forma1" target="_self" id="forma1" role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="modal-modificar-cat" role="dialog" aria-labelledby="modal-modificar-cat_myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="<?php echo site_url("serie/modificar_cat"); ?>" method="post" name="forma1" target="_self" id="forma1" role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                        <label for="Codigo_mod" class="col-sm-3 control-label">Sección</label>	
                                         <div class="col-sm-7"> 
                                            <input type="text" name="Codigo_mod" id="Codigo_mod" required value="" class="form-control" >
                                         </div>
                            </div>
