...
<!--script src="<?php echo site_url(); ?>js/less-1.3.3.min.js"></script-->
        ...
        <script>
            ...
            function uf_modificar_residencias(id) {

                $("#idCatalogo").val(id);
                $.ajax({
                    url: "<?php echo site_url('residencias/datos_residencia_get') ?>/" + id,
                    dataType: 'json',
    ...
    <body>
        <div class="container-fluid">
                    ...
                    <nav class="navbar navbar-default navbar-inverse navbar-fixed-top" role="navigation">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-left">
                                ...
                                <li><a href="#" title="Volver a las obras">Residencias </a>
                                </li>
                            </ul>
            ...
            <div class="row clearfix margen" style="margin-top: 70px; padding: 0 15px;">
                <div class="col-md-12 column">
                    <h3> Residencias</h3>
                    <button class="btn btn-primary" data-toggle="modal" data-target="#modal-nuevo-residencias" id="nuevo" style="margin-bottom:15px;" >
                        <span class="glyphicon glyphicon-plus"></span> Nueva Residencia
                    </button>
                </div>
                <div class="col-md-12">
                        ...
                        <table class="table table-striped table-hover table-bordered table-responsive small" id="tabla-scroll">
                            <thead>
                                <tr>
                                    ...
                                    <th>Nombre</th>
                                    <th class="col-md-1">Es Residencia</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                    if (isset($qResidencias)) {
                                        if ($qResidencias->num_rows() > 0) {
                                            foreach ($qResidencias->result() as $rSolicitud) {
                                                ?>
                                                <tr>
                                                    <td>
                                                        <a href="#" class="btn btn-success btn-xs" title=""  data-toggle="modal" data-target="#modal-modificar-residencias" role="button" onclick="uf_modificar_residencias(<?php echo $rSolicitud->id; ?>)"><span class="glyphicon glyphicon-pencil"></span></a>&nbsp;
                                                        <a class="btn btn-danger btn-xs del_documento" href="<?php echo site_url('residencias/residencia_delete/' . $rSolicitud->id); ?>" title="Eliminar Solicitud" onclick="return confirm('¿Confirma eliminar Registro?');" target="_self"><span class="glyphicon glyphicon-remove" ></span></a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <?php if ( $rSolicitud->Es_Residencia == 0) echo 'No';
                                                            else  echo 'Si'; ?>
                                                    </td>
            ...
            <!-- Dialogo Nuevo residencias -->
            <div class="modal fade" id="modal-nuevo-residencias" role="dialog" aria-labelledby="modal-agregar-cat_myModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-titlsamplee" id="modal-nuevo_documentomyModalLabel">Residencias - Nueva</h4>
                        </div>
                        <form action="<?php echo site_url('residencias/residencia_insert'); ?>" method="post" name="forma1" target="_self" id="forma1" role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
            ...
            <!-- Dialogo Modificar residencia -->
            <div class="modal fade" id="modal-modificar-residencias" role="dialog" aria-labelledby="modal-modificar-cat_myModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                            ...
                            <h4 class="modal-titlsamplee" id="modal-nuevo_documentomyModalLabel">Residencias - Modificar</h4>
                        </div>
                        <form action="<?php echo site_url("residencias/residencia_update"); ?>" method="post" name="forma1" target="_self" id="forma1" role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="modal-body">
