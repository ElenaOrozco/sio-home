    ...
    <head>
		...
		oTable = $('#tabla_scroll').dataTable({
                    ...
                    columnDefs: [ 
                        ...
                        {"targets": [1,2], 'className': 'small sinwarp'},
        ...
        function uf_modificar_proceso(id) {

                $("#idCatalogo").val(id);
               
                $.ajax({
                    url: "<?php echo site_url('procesos/datos_procesos') ?>/" + id,
                    dataType: 'json',
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12 column">
                        <a href="#modal-agregar-cat" class="btn btn-primary margin-boton" role="button" data-toggle="modal" ><span class="glyphicon glyphicon-plus"></span> Nuevo Proceso</a>
                </div>
                                                ...
                                                if (isset($qListado)) {
                                                    if ($qListado->num_rows() > 0) {
                                                        foreach ($qListado->result() as $rSolicitud) {
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <a href="#" class="btn btn-success btn-xs" title=""  data-toggle="modal" data-target="#modal-modificar-proceso" role="button" onclick="uf_modificar_proceso(<?php echo $rSolicitud->id; ?>)"><span class="glyphicon glyphicon-pencil"></span></a>&nbsp;
                                                                    <a class="btn btn-danger btn-xs del_documento" title="Eliminar Solicitud" onclick="return confirm('¿Confirma eliminar Registro?');" target="_self" href="<?php echo site_url('procesos/eliminar_proceso/' . $rSolicitud->id); ?>" ><span class="glyphicon glyphicon-remove" ></span></a>
                                                                </td>
                                                                <td>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-titlsamplee" id="modal-nuevo_documentomyModalLabel">Procesos - Nuevo</h4>
                    </div>
                    <form action="<?php echo site_url("procesos/agregar_proceso"); ?>" method="post" name="forma1" target="_self" id="forma1" role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            
                           
                            
                            <div class="form-group">
                                        <label for="nombre" class="col-sm-3 control-label">Nombre del proceso </label>	
                                         <div class="col-sm-7"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7"> 
                                    ...
                                    <input type="number" name="txtOrdenar" id="txtOrdenar" required value="" class="form-control" >
                                </div>
                            </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-titlsamplee" id="modal-nuevo_documentomyModalLabel">Modificar Proceso</h4>
                    </div>
                    <form action="<?php echo site_url("procesos/modificar_proceso"); ?>" method="post" name="forma1" target="_self" id="forma1" role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="ordenar" class="col-sm-3 control-label">Ordenar </label>
                                <div class="col-sm-7"> 
                                     <input type="number" name="txtOrdenar_mod" id="txtOrdenar_mod" required value="" class="form-control" >
                                    <!--select class="form-control" id="txtOrdenar_mod" name="txtOrdenar_mod">
                                        <option value = "0">
                                           No 
                                        </option>
                                        <option value = "1">
