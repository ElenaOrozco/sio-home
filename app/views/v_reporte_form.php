 ...
 <script type="text/javascript">
    ...
    $(document).ready(function(){
       $("#boton_buscar_legajo").click(function(){
        ...
        function uf_recibir_tipo_documento(idRel_Archivo_Documento, idArchivo) {
                        ...
                        if($("#tipo_documento"+idRel_Archivo_Documento).val()==3){
                            ...
                            $("#oculta-noHojas-"+idRel_Archivo_Documento).html("0")
                        }
       ...
       function uf_enviar_digitalizar(idProceso, idArchivo) {
        ...
        function cargar_estimaciones(idRel, idArchivo){
...
<html lang="es">
    <head>
        ...
        <!--link rel="stylesheet/less" href="http://10.5.6.117/siadar/less/bootstrap.less" type="text/css" /-->
        <!--link rel="stylesheet/less" href="http://10.5.6.117/siadar/less/responsive.less" type="text/css" /-->
        <!--script src="http://10.5.6.117/siadar/js/less-1.3.3.min.js"></script-->
        <!--append '#!watch' to the browser URL, then refresh the page. -->

        <link href="http://10.5.6.117/siadar/css/bootstrap.min.css" rel="stylesheet">
        <link href="http://10.5.6.117/siadar/css/style.css" rel="stylesheet">
        <link href="http://10.5.6.117/siadar/css/datatables.css" rel="stylesheet">
        <link href="http://10.5.6.117/siadar/css/dataTables.bootstrap.css" rel="stylesheet">
        <link href="http://10.5.6.117/siadar/css/jquery-confirm.css" rel="stylesheet">
        <!-- HTML5 shim, for IE6-8 support of HTML5 elements -->
        <!--[if lt IE 9]>
          <script src="http://10.5.6.117/siadar/js/html5shiv.js"></script>
        <![endif]-->

        <!-- Fav and touch icons -->
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="http://10.5.6.117/siadar/img/apple-touch-icon-144-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="114x114" href="http://10.5.6.117/siadar/img/apple-touch-icon-114-precomposed.png">
        <link rel="apple-touch-icon-precomposed" sizes="72x72" href="http://10.5.6.117/siadar/img/apple-touch-icon-72-precomposed.png">
        <link rel="apple-touch-icon-precomposed" href="http://10.5.6.117/siadar/img/apple-touch-icon-57-precomposed.png">
        <link rel="shortcut icon" href="http://10.5.6.117/siadar/img/favicon.png">

        <script type="text/javascript" src="http://10.5.6.117/siadar/js/jquery.min.js"></script>
        <script type="text/javascript" src="http://10.5.6.117/siadar/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="http://10.5.6.117/siadar/js/jquery.dataTables.min.js"></script>
        <script type="text/javascript" src="http://10.5.6.117/siadar/js/datatables.js"></script>
        <script type="text/javascript" src="http://10.5.6.117/siadar/js/jquery.dataTables.js"></script>
        <script type="text/javascript" src="http://10.5.6.117/siadar/js/dataTables.tableTools.js"></script>              
        <script type="text/javascript" src="http://10.5.6.117/siadar/js/dataTables.bootstrap.js"></script>   
        <script type="text/javascript" src="http://10.5.6.117/siadar/js/jquery.datatable.ajaxreload.js"></script>
        <script type="text/javascript" src="http://10.5.6.117/siadar/js/jquery.datatable.extraorder.js"></script>  
        <script type="text/javascript" src="http://10.5.6.117/siadar/js/jquery-confirm.js"></script>     
        <script type="text/javascript" src="http://10.5.6.117/siadar/js/scripts.js"></script>
    ...
    $(document).ready(function(){
       $("#boton_buscar_legajo").click(function(){
        ...
        function estatus(idArchivoo, idTDd, idProceso, idSubproceso){
            ...
            $.ajax({
                data:  parametros,
                url:   'http://10.5.6.117/siadar/archivo/estatus',
                dataType: 'json',
                quietMillis: 100,
                type:  'POST',
                success:  function (data) {
        ...
        function ubicacion_fisica(idArchivo, idTD, idProceso, idSubproceso){
            ...
            $.ajax({
                data:  parametros,
                url:   'http://10.5.6.117/siadar/archivo/ubicacion',
                dataType: 'json',
                quietMillis: 100,
                type:  'POST',
                success:  function (data) {
        ...
        function nuevo_doc_anexo(idArchivo,idRelDocumento,idProceso,idSubProceso, idDoc){
            ...
            $.ajax({
                data:  parametros,
                url:   'http://10.5.6.117/siadar/archivo/Tipo_Documento',
                dataType: 'json',
                quietMillis: 100,
                type:  'POST',
                success:  function (datan) {
            ...
            id=idDoc;
                ...
                var subdocumento=0;
                $.ajax({
                    url: "http://10.5.6.117/siadar/archivo/no_subdocumento/" + idDoc,
                    dataType: 'json',
                    success: function (data, textStatus, jqXHR) {
         ...
         function modificar_listado_sub_documentos_mod()
            {
                ...
                $.ajax({
                    url: "http://10.5.6.117/siadar/archivo/listado_sub_documentos_mod/" + id,
                    dataType: 'json',
                    success: function (data, textStatus, jqXHR) {
                        $("#listado_sub_documentos_mod").html(data);
                    }
        ...
        function modificar_sub_documento_mod(id)
            {
                ...
                $.ajax({
                    url: "http://10.5.6.117/siadar/archivo/datos_subdocumento/" + id,
                    dataType: 'json',
                    success: function (data, textStatus, jqXHR) {
                        var subdocumento =data['Nombre'];
                        $("#subdocumento_mod").html(subdocumento);
        ...
        function uf_modificar_archivo(id){
            $("#idCatalogo").val(id);
                //var marcado = $("#chkStatus").prop("checked") ? true : false;
                $.ajax({
                    url: "http://10.5.6.117/siadar/archivo/datos_archivo/" + id,
                    dataType: 'json',
                    success: function (data, textStatus, jqXHR) {
                        $("#OrdenTrabajo_mod").val(data['OrdenTrabajo']);
                        $("#Contrato_mod").val(data['Contrato']);
        ...
        function uf_recibir_documento(elemento,idRel_Archivo_Documento) {
                        ...
                        $.ajax({
                           type:"POST",
                           url:"http://10.5.6.117/siadar/archivo/edit_recibio/" + idRel_Archivo_Documento,
                           data: {recibido:recibido} ,
                           success: function(data) {
                             //$('.center').html(data); 
        ...
        function uf_recibir_tipo_documento(idRel_Archivo_Documento, idArchivo) {
                    ...
                    //alert ($("#tipo_documento"+idRel_Archivo_Documento).val())
                        ...
                        $.ajax({
                           type:"POST",
                           url:"http://10.5.6.117/siadar/archivo/edit_preregistrados/" + idRel_Archivo_Documento +'/' + idArchivo,
                           data: {preregistrado:preregistrado} ,
                           success: function(data) {
                             //$('.center').html(data); 
                                //alert('Data ' +data)
        ...
        function uf_recibir_estimacion(elemento,idEstimacion) {
                        ...
                        $.ajax({
                           type:"POST",
                           url:"http://10.5.6.117/siadar/archivo/edit_est_recibio/" + idEstimacion +'/' + Est_recibido,
                           data: {recibido:Est_recibido} ,
                           success: function (data) {
                             //$('.center').html(data); 
        ...
        function uf_recibir_tipo_estimacion(idEstimacion) {
                    ...
                    //alert ($("#tipo_documento"+idRel_Archivo_Documento).val())
                        ...
                        $.ajax({
                           type:"POST",
                           url:"http://10.5.6.117/siadar/archivo/edit_est_recibio/" + idEstimacion,
                           data: {recibido:recibido} ,
                           success: function(data) {
                             //$('.center').html(data); 
        ...
        function uf_original_recibido_estimacion(elemento,idEstimacion) {
                        ...
                        $.ajax({
                           type:"POST",
                           url:"http://10.5.6.117/siadar/archivo/edit_original_recibido_estimacion/" + idEstimacion +'/' + Est_original_recibido,
                           data: {original_recibido:Est_original_recibido} ,
                           success: function (data) {
                             //$('.center').html(data); 
        ...
        function uf_revisado_estimacion(elemento,idEstimacion) {
                        ...
                        $.ajax({
                           type:"POST",
                           url:"http://10.5.6.117/siadar/archivo/edit__revisado_estimacion/" + idEstimacion +'/' + Est_revisado,
                           data: {revisado:Est_revisado} ,
                           success: function (data) {
                             //$('.center').html(data); 
        ...
        function uf_orginal_recibido(elemento,idRel_Archivo_Documento) {
                        ...
                        $.ajax({
                           type:"POST",
                           url:"http://10.5.6.117/siadar/archivo/edit_original_recibio/" + idRel_Archivo_Documento,
                           data: {original_recibido:original_recibido} ,
                           success: function(data) {
                             //$('.center').html(data); 
        ...
        function uf_recibir_revisado(elemento,idRel_Archivo_Documento) {
                        ...
                        $.ajax({
                           type:"POST",
                           url:"http://10.5.6.117/siadar/archivo/edit_revisado/" + idRel_Archivo_Documento,
                           data: {revisado:revisado} ,
                           success: function(data) {
                             //$('.center').html(data); 
        ...
        function uf_recibido_cid(elemento,idRel_Archivo_Documento, direccion, tipo_documento , noHojas) {
                        ...
                        $.ajax({
                           type:"POST",
                           url:"http://10.5.6.117/siadar/archivo/edit_recibido_cid/" + idRel_Archivo_Documento+"/"+direccion +"/"+ tipo_documento +"/"+ noHojas,
                           data: {recibido_cid:recibido_cid} ,
                           success: function(data) {
                             //$('.center').html(data); 
                              //alert("id tipo proceso" +data["idTipoProceso"])
        ...
        function uf_orginal_revisado(elemento,idRel_Archivo_Documento) {
                        ...
                        $.ajax({
                           type:"POST",
                           url:"http://10.5.6.117/siadar/archivo/edit_original_revisado/" + idRel_Archivo_Documento,
                           data: {original_revisado:original_revisado} ,
                           success: function(data) {
                             //$('.center').html(data);
        ...
        function uf_ubicacion_fisica(elemento,idArchivo,idProceso) {
                        ...
                        $.ajax({
                           type:"POST",
                           url:"http://10.5.6.117/siadar/archivo/edit_ubicacion_fisica/" + idArchivo+"/"+idProceso,
                           data: {Ubicacion_fisica:Ubicacion_fisica} ,
                           success: function(data) {
                             //$('.center').html(data); 
                           }
        ...
        function uf_folio_desde(elemento,idArchivo,idProceso) {
                        ...
                        $.ajax({
                           type:"POST",
                           url:"http://10.5.6.117/siadar/archivo/edit_folio_desde/" + idArchivo+"/"+idProceso,
                           data: {folio_desde:folio_desde} ,
                           success: function(data) {
                             //$('.center').html(data); 
                           }
         ...
         function uf_folio_hasta(elemento,idArchivo,idProceso) {
                        ...
                        $.ajax({
                           type:"POST",
                           url:"http://10.5.6.117/siadar/archivo/edit_folio_hasta/" + idArchivo+"/"+idProceso,
                           data: {folio_hasta:folio_hasta} ,
                           success: function(data) {
                             //$('.center').html(data); 
                           }
        ...
        function ver_observaciones_archivo(idArchivo){
                    $.ajax({
                        type:"POST",
                        url:"http://10.5.6.117/siadar/archivo/ver_observaciones_archivo/" + idArchivo,
                        success: function(data) {
                         $('#idObservacionesArchivo').html(data["historial"]); 
                        }
                      });
        ...
        function ver_observaciones_documento(idArchivo,idProceso ,idSubTipoProceso, idDocumento){
                    $.ajax({
                        type:"POST",
                        url:"http://10.5.6.117/siadar/archivo/ver_observaciones_documento/" + idArchivo+"/"+idProceso+"/"+idSubTipoProceso+"/"+idDocumento,
                           success: function(data) {
                            $('#idObservacionesBloque').html(data["historial"]); 
                           }
                        });
        ...
        function ver_observaciones_documento_por_archivo(idArchivo){
                $.ajax({
                        type:"POST",
                        url:"http://10.5.6.117/siadar/archivo/ver_observaciones_documento_por_archivo/" + idArchivo,
                        success: function(data) {
                         $('#idObservacionesArchivo_Documento').html(data["historial"]); 
                        }
                      });
        ...
        function uf_ver_historia_bloque(idArchivo,idProceso) {
                        $.ajax({
                           type:"POST",
                           url:"http://10.5.6.117/siadar/archivo/ver_historia_bloque/" + idArchivo+"/"+idProceso,
                           success: function(data) {
                            $('#idHistorialBloque').html(data["historial"]); 
                           }
                         });
        ...
        function uf_ver_observaciones_bloque(idArchivo,idProceso ,idSubTipoProceso, idDocumento) {
                        $.ajax({
                           type:"POST",
                           url:"http://10.5.6.117/siadar/archivo/ver_observaciones_bloque/" + idArchivo+"/"+idProceso+"/"+idSubTipoProceso+"/"+idDocumento,
                           success: function(data) {
                            $('#idObservacionesBloque').html(data["historial"]); 
                           }
                         });
        ...
        function uf_ver_ubicacion_fisica_libre(idArea, idArchivo) {
                        ...
                        $.ajax({
                           type:"POST",
                           url:"http://10.5.6.117/siadar/archivo/ver_ubicaciones_libres_area/" + idArea + "/" +idArchivo, 
                           success: function(data) {
        ...
        function uf_ver_ubicacion_fisica_libre_mod(idArea, idArchivo) {
                        ...
                        $.ajax({
                           type:"POST",
                           url:"http://10.5.6.117/siadar/archivo/ver_ubicaciones_libres_mod/" + idArea + "/" +idArchivo,
                           success: function(data) {
       ...
       function uf_enviar_digitalizar(idProceso, idArchivo) {
        ...
        function uf_totales_recibidos_revisados(idArchivo,idProceso,idSubProceso) {
                        ...
                        $.ajax({
                           type:"POST",
                           url:"http://10.5.6.117/siadar/archivo/total_documentos_revisados/" + idArchivo+"/"+idProceso+"/"+idSubProceso,
                           success: function(data) {
                             alert(data["strSubTipoProceso_revisado"]);  
                             $('#numero_documentos_proceso_revisados'+data["idTipoProceso"]).html(data["strTipoProceso_revisado"])
                             $('#numero_documentos_subproceso_revisados'+data["idSubTipoProceso"]).html(data["strSubTipoProceso_revisado"])
                        ...
                        $.ajax({
                           type:"POST",
                           url:"http://10.5.6.117/siadar/archivo/total_documentos_recibidos/" + idArchivo+"/"+idProceso+"/"+idSubProceso,
                           success: function(data) {
                             $('#numero_documentos_proceso_recibidos'+data["idTipoProceso"]).html(data["strTipoProceso_recibido"])
                             $('#numero_documentos_subproceso_recibidos'+data["idSubTipoProceso"]).html(data["strSubTipoProceso_recibido"])
                           }
        ...
        function uf_modificar_ubicacion(id) {
                ...
                $("#idRel_mod").val(id);
                $.ajax({
                    url: "http://10.5.6.117/siadar/ubicacionFisica/datos_relacion_ubicacion/" + id,
                    dataType: 'json',
                    success: function (data, textStatus, jqXHR) {
                        //$idProceso = $("#Nombre_mod").val(data['Nombre']);
        ...
        function uf_agregar_documentos(idArchivo, idProceso){
            ...
            $("#idProceso_agregar").val(idProceso);
                $.ajax({
                    url: "http://10.5.6.117/siadar/archivo/listado_documentos_por_proceso/" + idProceso + "/" +idArchivo,
                    dataType: 'json',
                    success: function (data, textStatus, jqXHR) {
        ...
        function imprimir_documento_agregado(idDocumento, idProceso, idSubProceso, idArchivo){
            ...
            $.ajax({
                    url: "http://10.5.6.117/siadar/archivo/agregar_relacion_archivo_documento/" + idDocumento + "/" + idProceso + "/" + idSubProceso + "/" + idArchivo,
                    dataType: 'json',
                    success: function (data, textStatus, jqXHR) {
            ...
            location.href="http://10.5.6.117/siadar/archivo/cambios" +"/"  + idArchivo;
        }
        ...
        function cargar_identificador(id){
            ...
            $.ajax({
                    url: "http://10.5.6.117/siadar/archivo/cargar_identificador/" + id + "/" + identificador,
                    dataType: 'json',
                    success: function (data, textStatus, jqXHR) {
        ...
        function cargar_bloqueObra(id){
            ...
            $.ajax({
                    url: "http://10.5.6.117/siadar/archivo/cargar_idBloqueObra/" + id + "/" + bloque,
                    dataType: 'json',
                    success: function (data, textStatus, jqXHR) {
        ...
        function uf_modificar_observacion(id){
                ...
                $.ajax({
                    url: "http://10.5.6.117/siadar/observaciones/datos_observacion/" + id,
                    dataType: 'json',
                    success: function (data, textStatus, jqXHR) {
			$("#OrdenTrabajo").html(data['OrdenTrabajo']);
                        $("#Contrato").html(data['Contrato']);
        ...
        function modificar_bloque(id)
            {
                ...
                $.ajax({
                    url: "http://10.5.6.117/siadar/archivo/datos_bloque/" + id,
                    dataType: 'json',
                    success: function (data, textStatus, jqXHR) {
        ...
        function checar_estado_trabajo(elemento, id, idArchivo, preregistro, recibir, revisar, foliar, validar, digitalizar, editar, usuario, tipo){
            ...
            if (elemento.checked){
                ...
                $.ajax({
                    //id= idProceso
                    url: "http://10.5.6.117/siadar/archivo/comprobar_estado_trabajo/" + id  + "/" + idArchivo,
                    dataType: 'json',
                    success: function (data, textStatus, jqXHR) {
                      //$("#estado-trabajo-"+id).html(data['idUsuario_Trabajando']);  
                      if( data['idUsuario_Trabajando'] != 0){
        ...
        function uf_modificar_estado_trabajo(elemento, id, idArchivo, preregistro, recibir, revisar, foliar, validar, digitalizar, editar){
            ...
            $.ajax({
                    url: "http://10.5.6.117/siadar/archivo/estado_trabajo/" + id + "/" + trabajando + "/" + idArchivo,
                    dataType: 'json',
                    success: function (data, textStatus, jqXHR) {
        ...
        function liberar_estado_trabajo(idProceso, idArchivo, tipo){
            ...
            //alert("Entro " +tipo)
            $.ajax({
                    url: "http://10.5.6.117/siadar/archivo/estado_trabajo/" + idProceso + "/" + trabajando + "/" + idArchivo,
                    dataType: 'json',
                    success: function (data, textStatus, jqXHR) {
                       //alert("Succes") 
        ...
        //var valor = document.getElementById("texto").value;
            ...
            $.ajax({
                    ...
                    url: "http://10.5.6.117/siadar/archivo/cargar_noHojas/" + idRelacion +  "/" + idArchivo +  "/" + hojas,
                    dataType: 'json',
                    success: function (data, textStatus, jqXHR) {
                         $("#noHojas_doc_"+idRelacion).val(data['noHojas']);
        ...
        function agregar_observaciones_documento(){
            ...
            if ($("#tipo_observacion").prop("checked")){
                ...
                $.ajax({
                    ...
                    type: "POST",
                    dataType: "json",
                    url: "http://10.5.6.117/siadar/archivo/agregar_observaciones_documento",
                })
                 .done(function( data, textStatus, jqXHR ) {
                     if ( console && console.log ) {
                         console.log( "La solicitud se ha completado correctamente." );
        ...
        function agregar_ubicacion_fisica(idArchivo){
            ...
            $("#modal-agregar-ubicacion-fisica").modal('hide');
                $.ajax({
                    ...
                    type: "POST",
                    url: "http://10.5.6.117/siadar/archivo/agregar_ubicacion_fisica",
                     success: function (data, textStatus, jqXHR) {
                        dibujar_tabla_ubicaciones(idArchivo, proceso)
                        $("#idUbicacionFisica").val("") 
                        $("#txtCaja").val("")
        ...
        function dibujar_tabla_ubicaciones(idArchivo, proceso){
            ...
            $.ajax({
                    ...
                    url: "http://10.5.6.117/siadar/archivo/ver_ubicaciones_proceso/" +idArchivo+"/"+proceso,
                    success: function (data) {
        ...
        function cargar_estimaciones(idRel, idArchivo){
            ...
            var estimaciones = $("#noEstimaciones").val(); 
                $.ajax({
                    ...
                    url: "http://10.5.6.117/siadar/archivo/cargar_estimaciones/" + idRel+"/"+idArchivo+"/"+estimaciones,
                    success: function (data) {
        ...
        function dibujar_tabla_estimaciones(idRel, idArchivo){
            $.ajax({
                    ...
                    url: "http://10.5.6.117/siadar/archivo/ver_estimaciones_relacion/" +idArchivo+"/"+idRel,
                    success: function (data) {
                ...
                buttons: {
                    Si: function () {
                        $.ajax({
                            ...
                            type: "POST",
                            url: "http://10.5.6.117/siadar/archivo/eliminar_estimacion/"+Numero_Estimacion  + "/" +idRel,
                             success: function (data, textStatus, jqXHR) {
                                    //alert("Eliminado")
                                    dibujar_tabla_estimaciones(idRel, idArchivo)
                   ...
                   if (isset($qUsuario_trabajando)) {
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                             <?php if ($recibe ==1 || $reviso ==1 || $Foliar ==1){
                                        echo 'PErmiso R, R, F' . $recibe  . $reviso  . $Foliar ;
                    ...
                    <?php 
                         $value=""; 
                          ...
                          if ($preregistro ==1){
                            if ($rRowDocumentos->original_recibido==0 && $rRowDocumentos->copia==0 && $rRowDocumentos->no_aplica==0){
                            ...
                            } else if ($rRowDocumentos->original_recibido==1 && ($rRowDocumentos->direccion_preregistro == $idDireccion_responsable)){
                            ...
                            } else if ($rRowDocumentos->copia==1 && ($rRowDocumentos->direccion_preregistro == $idDireccion_responsable)){
                                ...
                                $seleccion3 = "Selecciona una opción";
                                $value3 = 'value="0"';
                            }else if ($rRowDocumentos->no_aplica==1 && ($rRowDocumentos->direccion_preregistro == $idDireccion_responsable)){
                                //echo "Se recibio copia";
                                $seleccion = "No Aplica";
                                $value= 'value="3"';
                                $seleccion1 = "Original";
                            ...
                            <div class="col-sm-2  m-b-separacion" >
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 m-b">
                                        ...
                                        <?php } else { ?>
                                        <select class="form-control" name="tipo_documento<?php echo $rRowDocumentos->id; ?>" id="tipo_documento<?php echo $rRowDocumentos->id; ?>" onchange="uf_recibir_tipo_documento(<?= $rRowDocumentos->id; ?>,<?= $idArchivo ?>)">
                                            <option   id="select<?php echo $rRowDocumentos->id; ?>" name="select<?php echo $rRowDocumentos->id; ?>"></option>
                                            <option   <?php echo $value ?> id="select<?php echo $rRowDocumentos->id; ?>" name="select<?php echo $rRowDocumentos->id; ?>"><?php echo $seleccion ?></option>
                                            <option id="tipo_documento<?php echo $rRowDocumentos->id; ?>" name="tipo_documento<?php echo $rRowDocumentos->id; ?>" <?php echo $value1 ?> > <?php echo $seleccion1 ?> </option>
                                            <option id="tipo_documento<?php echo $rRowDocumentos->id; ?>" name="tipo_documento<?php echo $rRowDocumentos->id; ?>" <?php echo $value2 ?> > <?php echo $seleccion2 ?> </option>
                                            <option id="tipo_documento<?php echo $rRowDocumentos->id; ?>" name="tipo_documento<?php echo $rRowDocumentos->id; ?>" <?php echo $value3 ?> > <?php echo $seleccion3 ?> </option>
                                    ...
                                    <div class="col-sm-12 align-end">
                                                           ...
                                                           <!-- $rRowDocumentos->id  ==  id Rel_Archivo_Documento -->
                                                                 <form class="m-b">
                                                                     <div class="">
                                                                       ...
                                                                       <input type="number" class="form-control" id="noHojas_doc_<?= $rRowDocumentos->id ?>" name="noHojas_doc" placeholder="No Hojas" value="" onchange="cargar_noHojas(<?= $rRowDocumentos->id ?>, <?= $idArchivo ?>)">
                                                                     </div>
                                                           ...
                                                           <?php if($preregistro ==1 && $rRowDocumentos->noHojas && ($rRowDocumentos->direccion_preregistro == $idDireccion_responsable)){ ?>
                                                            <div id="noHojas-<?= $rRowDocumentos->id ?>" class="col-sm-12"> <?php echo '<b>No Hojas: </b>' . $rRowDocumentos->noHojas?></div>
                                                           <?php } ?>
                                                            <?php if($rRowDocumentos->noHojas && $recibe ==1){ ?>
                                                            <div id="noHojas-<?= $rRowDocumentos->id ?>" class="col-sm-12 d-n"> <?php echo '<b>No Hojas: </b>' . $rRowDocumentos->noHojas?></div>
                                                           <?php } ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <?php
                                            ...
                                            <?php if ($preregistro==1 || $recibe == 1 || $reviso ==1){ 
                                                    $style ="";
                                                        ...
                                                        <div class="col-xs-12 col-sm-12" align="end" style="text-align: end; margin-top: 20px">
                                                                   ...
                                                                   <!-- $rRowDocumentos->id  ==  id Rel_Archivo_Documento -->
                                                                         <form class="form-inline">
                                                                             ...
                                                                             <button type="button" class="btn btn-default" onclick="cargar_estimaciones(<?= $rRowDocumentos->id  ?>, <?= $idArchivo ?>)">Agregar</button>
                                                                         </form>
                                                                    ...
                                                                    <div class="col-md-5">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <select class="form-control" name="tipo_documento_est<?php echo $rEstimaciones->id; ?>" id="tipo_documento_est<?php echo $rEstimaciones->id; ?>" onchange="uf_recibir_tipo_estimacion(<?= $rEstimaciones->id;?>)" >
                                                                                ...
                                                                                <option id="tipo_documento_est<?php echo $rEstimaciones->id; ?>" name="tipo_documento_est<?php echo $rEstimaciones->id; ?>" value="2">No Aplica</option>
                                                                              </select>
                                                                        </div>
                                                                        <?php if($reviso ==1 ){
                                                                            $disable_estimacion= "";
...
WHERE id_Rel_Archivo_Documento =" .$rRowDocumentos->id. " AND (tipo_documento = 1 OR tipo_documento =2 OR tipo_documento =3) AND preregistro_aceptado = 1" );
                    ...
                    ?>
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" <?= $aceptado ?> value="" onchange="uf_recibido_cid(this, <?= $rPreregistros->id_Rel_Archivo_Documento ?>, <?= $rPreregistros->idDireccion_responsable ?>, <?= $rPreregistros->tipo_documento ?>, <?= $rPreregistros->noHojas ?>)">
                                    <?= $addw_catDireccion[$rPreregistros->idDireccion_responsable] ?>
                                ...
                                <div>
                                    ...
                                    ?>
                                        <div id="info-<?= $rPreregistros->id_Rel_Archivo_Documento ?>" >
                                            <?php echo "Entrego: Copia </br>"; ?>
                                            <?php echo 'No Hojas: '. $rPreregistros->noHojas  .' </br>';?>
                                        </div>
                                    <?php    }else if ($rPreregistros->tipo_documento == 2){  ?>
                                        <div id="info-<?= $rPreregistros->id_Rel_Archivo_Documento ?>">
                                            <?php echo 'Entrego: Original </br>';?>
                                            <?php echo 'No Hojas: '. $rPreregistros->noHojas  .' </br>'; ?>
                                        </div>
                                    
                                    <?php    }else {  ?>
                                        <div id="info-<?= $rPreregistros->id_Rel_Archivo_Documento ?>">
                                            <?php echo 'Entrego: No Aplica </br>';?>
