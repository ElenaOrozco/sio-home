...
<html lang="es">
    <head>
        ...
        function uf_modificar_titularidad(id) {

                $("#idCatalogo").val(id);
               
                $.ajax({
                    url: "<?php echo site_url('titularidad/datos_titularidad') ?>/" + id,
                    dataType: 'json',
                    success: function (data, textStatus, jqXHR) {
			            $("#Titulo_mod").val(data['Titulo']);
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-md-12 column">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Titularidad</li>
                    </ol>
                </div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12 column">
                        <a href="#modal-agregar-titularidad" class="btn btn-primary" role="button" data-toggle="modal" ><span class="glyphicon glyphicon-plus"></span> Nueva Titularidad</a>
                </div>
                                                ...
                                                if (isset($qListado)) {
                                                    if ($qListado->num_rows() > 0) {
                                                        foreach ($qListado->result() as $rSolicitud) {
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <a href="#" class="btn btn-success btn-xs" title=""  data-toggle="modal" data-target="#modal-modificar-titularidad" role="button" onclick="uf_modificar_titularidad(<?php echo $rSolicitud->id; ?>)"><span class="glyphicon glyphicon-pencil"></span></a>&nbsp;
                                                                    <a class="btn btn-danger btn-xs del_documento" title="Eliminar Solicitud" onclick="return confirm('¿Confirma eliminar Registro?');" target="_self" href="<?php echo site_url('titularidad/eliminar_titularidad/' . $rSolicitud->id); ?>" ><span class="glyphicon glyphicon-remove" ></span></a>
                                                                </td>
                                                                <td>
                                                                    <?php echo $rSolicitud->Titulo; ?>
                                                                </td>
          ...
          <!-- Dialogo Nuevo titularidad -->
        <div class="modal fade" id="modal-agregar-titularidad" role="dialog" aria-labelledby="modal-agregar-cat_myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-titlsamplee" id="modal-nuevo_documentomyModalLabel">Titularidad - Nueva</h4>
                    </div>
                    <form action="<?php echo site_url("titularidad/agregar_titularidad"); ?>" method="post" name="forma1" target="_self" id="forma1" role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            
                           
                            
                            <div class="form-group">
                                        <label for="titulo" class="col-sm-3 control-label">Nombre titularidad </label>	
                                         <div class="col-sm-7"> 
          ...
          <!-- Dialogo Modificar Proc -->
        <div class="modal fade" id="modal-modificar-titularidad" role="dialog" aria-labelledby="modal-modificar-cat_myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                        ...
                        <h4 class="modal-titlsamplee" id="modal-nuevo_documentomyModalLabel">Modificar Titularidad</h4>
                    </div>
                    <form action="<?php echo site_url("titularidad/modificar_titularidad"); ?>" method="post" name="forma1" target="_self" id="forma1" role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            
                            
                             <div class="form-group">
                                        <label for="titulo_mod" class="col-sm-3 control-label">Titularidad </label>	
                                         <div class="col-sm-7"> 
                                            <input type="text" name="Titulo_mod" id="Titulo_mod" required value="" class="form-control" >
                                         </div>
                            </div>  
